...
public class RoleDAO extends HibernateDaoSupport  {
	...
	public static final String ROLE_MIAO_SHU = "roleMiaoShu";
	public static final String ROLE_KZ = "roleKz";
	...
	public List findByRoleMiaoShu(Object roleMiaoShu
	) {
		return findByProperty(ROLE_MIAO_SHU, roleMiaoShu
		);
	}
	
	public List findByRoleKz(Object roleKz
	) {
		return findByProperty(ROLE_KZ, roleKz
		);
	}
